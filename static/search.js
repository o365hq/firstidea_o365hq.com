function debounce(func, wait) {
  ...
  function toggleSearchMode() {
    ...
    var $global_nav = document.querySelector("#global_nav");
  ...
  function initSearch() {
    ...
    $searchInput.addEventListener("keyup", debounce(function() {
      ...
      if (results.length === 0) {
        $searchResultsHeader.innerText = `Sorry, nothing like «${term}»`;
        return;
      }
  
      currentTerm = term;
        $searchResultsHeader.innerText = `${results.length} pages found for «${term}»:`;
